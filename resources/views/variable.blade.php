    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 py-16 pt-16">
        <div class="flex md:flex-row flex-col justify-between gap-8">
            ...
            <div class="bg-gradient-to-br from-gray-700 to-gray-800 rounded-lg shadow-xl p-4 mx-4">
                ...
                <h2 class="text-gray-400 mb-4">Ici, vous devrez inscrire vos variables si vous voulez que vos calculs ne soient pas faussés ou corrompus. Un souci ? Regardez la <a href="/" class="text-blue-500 hover:underline">Documentation</a>.</h2>
            ...
            <div class="bg-gradient-to-br from-gray-700 to-gray-800 rounded-lg shadow-xl p-4 mx-4">
                ...
                <p class="text-gray-400 mb-4">Retrouvez les dernières informations inscrites des variables <a href="/documentation" class="text-blue-500 hover:underline">En savoir plus</a></p>
                <div class="max-h-96">
                    <table class="w-full">
                        <thead>
